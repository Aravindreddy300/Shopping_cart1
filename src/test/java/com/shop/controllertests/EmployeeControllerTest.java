...
//    @Test
//    public void getEmployeeOrdersById_NonExistingId_ShouldThrowException() throws EmployeeNotFoundException {
//        Long employeeId = 1L;
//        when(employeeService.getEmployeeOrderById(employeeId)).thenReturn(null);
//
//        assertThrows(EmployeeNotFoundException.class, () -> employeeController.getEmployeeOrdersById(employeeId));
//        verify(employeeService, times(1)).getEmployeeOrderById(employeeId);
//    }

    // Add tests for other methods in the EmployeeController class
