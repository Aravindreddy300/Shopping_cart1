...
//    @Test
//    public void getCartByCustomerId_ExistingCustomerId_ShouldReturnCart() throws CartItemNotFoundException {
//        Long customerId = 1L;
//        Cart mockCart = new Cart();
//        when(cartService.getCartByCustomerId(customerId)).thenReturn(mockCart);
//
//        Cart result = cartController.getCartByCustomerId(customerId);
//
