/*
 * Controller class for managing Customer-related HTTP requests.
 * Implements methods to handle customer operations, including creating a new customer, retrieving all customers,
 * getting a customer by ID, and updating a customer.
 */
