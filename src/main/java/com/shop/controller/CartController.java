/*
 * Controller class for managing Cart-related HTTP requests.
 * Implements methods to handle cart operations, including adding products to the cart, retrieving cart items,
 * getting the cart by customer ID, and deleting the cart by cart ID.
 */
