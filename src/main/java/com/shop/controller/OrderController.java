/*
 * Controller class for managing Order-related HTTP requests.
 * Implements methods to handle order operations, including retrieving orders by customer ID and creating a new order for a customer.
 */
